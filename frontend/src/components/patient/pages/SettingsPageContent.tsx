...
import { DashCard, DashPageHeader, SettingsRow } from "@/components/patient/ui/PatientPrimitives";
...
export function SettingsPageContent() {
  ...
  return (
    <>
      <DashPageHeader subtitle="🏥 Patient Dashboard" title="Settings" dateStr={todayFormatted()} />
