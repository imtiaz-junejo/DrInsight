...
export function DoctorSiteTopbar() {
  return (
...
export function DoctorSiteNav() {
  const mobileMenuOpen = useDoctorUiStore((s) => s.mobileMenuOpen);
  const toggleMobileMenu = useDoctorUiStore((s) => s.toggleMobileMenu);
  const setMobileMenuOpen = useDoctorUiStore((s) => s.setMobileMenuOpen);
...
export function DoctorDemoBar() {
  return (
    <div className="demo-bar">
      <div className="demo-bar-inner">
        <strong>🩺 Physician Dashboard</strong>
