  ...
  async function submitForm() {
    ...
    try {
      ...
      if (newsletter && email.trim()) {
        await newsletterSubscribe.mutateAsync({ email: email.trim(), source: "contact-form" });
      }
    ...
    <div className="contact-page">
      ...
      <div className="contact-cards-section">
        <div className="contact-cards">
          {contactCards.map((card) => (
            <div key={card.title} className="contact-card border border-gray-300 bg-white">
      ...
      <div className="main-section">
        <div className="main-column">
          <div className="form-card bg-gray-200">
          ...
          <div className="faq-mini bg-gray-200">
            ...
            <div className="faq-grid">
              {faqItems.map((item, i) => (
                <div
                  key={item.q}
                  className={`faq-item bg-white${openFaq === i ? " open" : ""}`}
                  onClick={() => toggleFAQ(i)}
        ...
        <div className="sidebar">
          <div className="sidebar-card sidebar-card-tone border border-gray-300 bg-white">
          ...
          <div className="sidebar-card map-card border border-gray-300 bg-white">
            <h3>🗺️ Find Us</h3>
            <a
              href={contact ? mapsHref(contact) : "#"}
              target="_blank"
              rel="noopener noreferrer"
              className="map-placeholder bg-gray-200"
            >
